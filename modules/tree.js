...
function findChildren(children, index, n, old_path) {
  if (index < n) {
    //build first child
...
module.exports.build = function(children, index, n, old_path) {
  let node = {
    path: old_path,
    name: old_path,
    rightSib: null,
  ...
  node.leftChild = findSiblings(children, index, n, old_path);
  return node;
};
